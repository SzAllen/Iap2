...
{
	for(int i = 0; i < g_TestCaseTreeData.m_nUnitTreeNodeDatas; i++)
	{
		if(pCmdLine == &g_TestCaseTreeData.m_CmdLine[i])
		{
			g_TestCaseTreeData.m_pUnitTreeNodeDatas[i]->Run(g_TestCaseTreeData.m_pUnitTreeNodeDatas[i]);
		}
	}
