...
/////////////////////////////////////////////////////////////
void CHTMLDrawer::DrawText(CDC * pDC, const CString & strText,const CHTMLFont & fntDefault,CRect & rctPosition,short nAlignment)
{
	...
	DrawAtoms(pDC,arrDisplayAtoms,RGB(0,0,0),false);
...
// pDC : Device context
/////////////////////////////////////////////////////////////
void CHTMLDrawer::Draw(CDC * pDC,COLORREF rgbHighlight,bool isUnderlineWhenHighlight)
{
	// Draw them
	DrawAtoms(pDC,m_arrDisplayAtoms,rgbHighlight,isUnderlineWhenHighlight);
}
...
void CHTMLDrawer::DrawAtoms(CDC * pDC,CObArray & arrDisplayAtoms,COLORREF rgbHighlight,bool	isUnderlineWhenHighlight)
{
