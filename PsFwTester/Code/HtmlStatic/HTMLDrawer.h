...
public:
	static void DrawText(CDC * pDC, const CString & strText,const CHTMLFont & fntDefault,CRect & rctPosition,short nAlignment);
	
	int PrepareDraw(CDC * pDC, const CString & strText,const CHTMLFont & fntDefault,CRect & rctPosition,short nAlignment);
	void Draw(CDC * pDC,COLORREF rgbHighlight,bool isUnderlineWhenHighlight);
...
protected:
	...
	static void DrawAtoms(CDC * pDC,CObArray & arrDisplayAtoms,COLORREF rgbHighlight,bool isUnderlineWhenHighlight);
