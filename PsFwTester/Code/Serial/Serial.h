...
public:
	...
	static void FormatComPort(CString& comPort);
	static CString FormatComPort(LPCTSTR lpComPort);
	static int GetSystemPorts(CStringArray& portList, CStringArray* pNameList = NULL);
...
extern const LPCTSTR m_BaudrateStr[];
extern const LPCTSTR m_DataBitsStr[];
extern const LPCTSTR m_ParityStr[];
extern const LPCTSTR m_StopBitsStr[];
extern const LPCTSTR m_HandshakeStr[];
