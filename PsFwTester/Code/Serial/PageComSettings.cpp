...
BOOL CPageComSettings::OnApply() 
{
	...
	// Call base class
	g_Profile.WriteInt(g_pComSettingSection, g_pComSetting[Baudrate], eBaudrate);
	g_Profile.WriteInt(g_pComSettingSection, g_pComSetting[Databits], eDataBits);
	g_Profile.WriteInt(g_pComSettingSection, g_pComSetting[Parity]  , eParity);
	g_Profile.WriteInt(g_pComSettingSection, g_pComSetting[Stopbits], eStopBits);
